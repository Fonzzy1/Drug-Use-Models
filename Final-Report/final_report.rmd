...
## SUAR Model
The SIR model fails to distingush between different severities of addiction. By grouping the individuals who are trying/testing the drug t people who are addicted in the same group we are failing to capture the behaviour of people trying the drug without becoming reliant on the drug.
